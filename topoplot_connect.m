...
rmax = 0.49;             % actual head radius - 0.5 Don't change this!
...
EMARKERSIZE = [5];       % default depends on number of electrodes, set in code (empty)
EMARKERLINEWIDTH = 1;   % default edge linewidth for emarkers
HLINEWIDTH = 1;         % default linewidth for head, nose, ears (1.7)
HEADRINGWIDTH    = .00007;% width of the cartoon head ring (0.007)
