...
================================
-iniCond_N_BuIndivSubj_8 
-run_iniCond_N_BuIndivSubj_8.sh (shell script for temporarily setting environment 
                                 variables and executing the application)
   -to run the shell script, type
   
       ./run_iniCond_N_BuIndivSubj_8.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v84, run the shell script as:
       ...
       ./run_iniCond_N_BuIndivSubj_8.sh /mathworks/home/application/v84
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_iniCond_N_BuIndivSubj_8.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_iniCond_N_BuIndivSubj_8.sh 
