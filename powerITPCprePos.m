...
% concatenates both and do the hilbert transform per trial. Then it computes ITPC and Power for each of the 50-msec time windows of anlysis. It requires "eventprob" variable from the HSMM-MVPA output. "eventprob" contains the probability distribution of the location of a bump
