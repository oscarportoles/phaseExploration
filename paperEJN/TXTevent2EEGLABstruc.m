% It opens the text file with the events code and matches the events on the tex file to the
...
% 
% Caution!! A 'boundary' event can lay between Onset and Response events on the
...
% Coose your own data paths

clear all
close all
clc

pathevents = '/Data_JB_AssoRec/Corrected/';
fnames = dir([pathevents '*.txt']);
Nsj = size(fnames,1);

pathdata = '/Data_JB_AssoRec/DS100bp1_35/';
snames = dir([pathdata '*.set']);

pathsave = '/Data_JB_AssoRec/DS100bp1_35/events/';
