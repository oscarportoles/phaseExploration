function hpol = polaRad(varargin)
    ...
    fAxSize = get(cax, 'DefaultAxesFontSize');
    ...
    if ~hold_state
        ...
        for i = (rmin + rinc) : rinc : rmax
            hhh = line(xunit * i, yunit * i, 'LineStyle', ls, 'Color', tc, 'LineWidth', 3, ...
                'HandleVisibility', 'off', 'Parent', cax); % Oscar
...
%                 'HandleVisibility', 'off', 'Parent', cax); 
        ...
        cs = [-cst; cst];
        sn = [-snt; snt];
        line(rmax * cs, rmax * sn, 'LineStyle', ls, 'Color', tc, 'LineWidth', 3, ...
            'HandleVisibility', 'off', 'Parent', cax);  % Oscar
...
%             'HandleVisibility', 'off', 'Parent', cax);
        ...
        text_strings = {'\pi/6'  '\pi/3'  '\pi/2'  '2\pi/3' '5\pi/6'  '\pi' ...
                        '-5\pi/6' '-2\pi/3' '-\pi/2' '-\pi/3' '-\pi/6' '0'}; % Oscar
%         text_strings = {' '  ' '  '\pi/2'  ' ' ' '  '\pi' ...
%                         ' ' ' ' '3\pi/2' ' ' ' ' '0'}; % Oscar
        for i = 1 : length(th)
